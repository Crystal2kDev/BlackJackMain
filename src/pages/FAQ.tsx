...
const FAQ: React.FC = () => {
  ...
  const faqData = [
    {
      question: 'Что такое TableRush?',
      answer:
        'TableRush — современная онлайн-платформа для карточных настольных игр. ' +
      ...
      <div className="faq-container">
        <header className="faq-header">
          <motion.h1 initial={{ y: -8, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.36 }}>
            Часто задаваемые вопросы — TableRush
          </motion.h1>
        ...
        <main className="faq-main">
          <section id="overview" className="faq-section">
            <h2>Обзор</h2>
            <p>
              TableRush — это площадка для бесплатной игры в настольные карточные игры онлайн. Здесь вы сможете играть как против бота, так и в приватных комнатах с друзьями.
            </p>
          </section>
          ...
          <section id="legal" className="faq-section">
            ...
            <p>
              TableRush не является оператором азартных игр. Пользование платформой должно соответствовать законодательству вашей страны. При юридических вопросах — консультируйтесь со специалистами.
            </p>
          </section>
